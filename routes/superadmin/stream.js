...
const savectrl = require('../../controllers/superadmin/stream/save');
const deletectrl = require('../../controllers/superadmin/stream/delete');
const paginatectrl = require('../../controllers/superadmin/stream/list');
const listctrl = require('../../controllers/superadmin/stream/list');
const statusctrl = require('../../controllers/superadmin/stream/status');
